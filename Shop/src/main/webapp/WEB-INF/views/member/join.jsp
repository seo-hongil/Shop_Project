	...
	<div class="wrap">
			...
			<div class="pwck_wrap">
				...
				<span class="final_pwck_ck">비밀번호 확인을 입력해주세요.</span>
				  <span class="pwck_input_ck_1">비밀번호가 일치합니다.</span>
                <span class="pwck_input_ck_2">비밀번호가 일치하지 않습니다.</span>
			</div>
			<div class="user_wrap">
			...
			<div class="address_wrap">
				...
				<div class ="address_input_3_wrap">
					<div class="address_input_3_box">
						<input class="address_input_3" name="memberAddr3" readonly="readonly" placeholder="상세주소">
					</div>
				</div>
...
$('.pwck_input').on("propertychange change keyup paste input", function(){
    ...
    if(pw == pwck){
        $('.pwck_input_ck_1').css('display','block');
        $('.pwck_input_ck_2').css('display','none');
        pwckcorCheck = true;
        
    }else{
        $('.pwck_input_ck_1').css('display','none');
        $('.pwck_input_ck_2').css('display','block');
        pwckcorCheck = false;
...
$(".mail_check_input").blur(function(){
    ...
    if(inputCode == code){                            // 일치할 경우
        ...
        mailnumCheck = true;     // (유효성) 일치할 경우
        
    } else {                                            // 일치하지 않을 경우
        checkResult.html("인증번호를 다시 확인해주세요.");
        checkResult.attr("class", "incorrect");
        mailnumCheck = false;    //  (유효성) 일치하지 않을 경우
        if(inputCode==""){
        	  checkResult.html("");
        }
    }    
